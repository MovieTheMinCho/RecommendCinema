...
import com.example.mre2.springboot.domain.posts.Posts;
import com.example.mre2.springboot.domain.posts.PostsRepository;
...
public class PostsApiControllerTest{
    ...
    @Test
    @WithMockUser(roles="USER")
    public void testAmendedPosts() throws Exception {
        //given
